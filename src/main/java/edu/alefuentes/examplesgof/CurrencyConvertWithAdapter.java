...
class CurrencyAdapter {
    ...
    public double convertUSDtoEUR(double mount) {
        double ammountInGBP = oldConverter.convertUSDtoGBP(mount);
        double amoutnInEur = ammountInGBP * 1.0625;
...
public class CurrencyConvertWithAdapter {
